  ...
  step_six = () => {
    return (
        <div>
          ...
          <button onClick={() => {
            this.setState({answerQuestions:{ questionSix: 'si'}});
            this.controller_step();
          }}>Si</button>

          <button onClick={() => {
            this.setState({answerQuestions:{ questionSix: 'no'}});
            this.controller_step();
          }}>No</button>

          <button onClick={() => {
            this.setState({answerQuestions:{ questionSix: 'nose'}});
            this.controller_step();
          }}>No lo sé</button>
  ...
  step_five = () => {
    return (
        <div>
          ...
          <button onClick={() => {
            this.setState({answerQuestions:{ questionFive: 'si'}});
            this.controller_step();
          }}>Si</button>

          <button onClick={() => {
            this.setState({answerQuestions:{ questionFive: 'no'}});
            this.controller_step();
          }}>No</button>

          <button onClick={() => {
            this.setState({answerQuestions:{ questionFive: 'nose'}});
            this.controller_step();
          }}>No lo sé</button>
  ...
  step_four = () => {
    return (
        <div>
          ...
          <button onClick={() => {
            this.setState({answerQuestions:{questionFour: 'si'}});
            this.controller_step();
          }}>Si</button>

          <button onClick={() => {
            this.setState({answerQuestions:{questionFour: 'no'}});
            this.controller_step();
          }}>No</button>

          <button onClick={() => {
            this.setState({answerQuestions:{questionFour: 'nose'}});
            this.controller_step();
          }}>No lo sé</button>
  ...
  step_one = () => {
    return(
        <div>
          ...
          <p>{this.state.answerQuestions.questionOne}</p>
        </div>
    )
  };
  welcomeStep = () => {
